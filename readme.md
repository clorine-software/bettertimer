...
```sh
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/clorine-software/bettertimer/releases/download/v1.0.3/bettertimer-installer.sh | sh
```
...
```powershell
powershell -ExecutionPolicy Bypass -c "irm https://github.com/clorine-software/bettertimer/releases/download/v1.0.3/bettertimer-installer.ps1 | iex"
```
